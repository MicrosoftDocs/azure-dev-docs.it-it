...
- Creare un nuovo [progetto DevOps di Azure](https://docs.microsoft.com/vsts/organizations/projects/create-project?view=vsts&tabs=new-nav) e usare l'URL GIT precedente per **importare un repository**
- Creare un [Registro Azure Container](https://azure.microsoft.com/services/container-registry)
