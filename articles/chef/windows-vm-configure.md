...
Scaricare e installare la versione più recente dell'[interfaccia della riga di comando di Azure](/cli/azure/install-azure-cli?view=azure-cli-latest) nella workstation.
...
## <a name="configure-chef-server"></a>Configurare il server Chef
...
### <a name="create-a-hosted-chef-account"></a>Creare un account Chef ospitato
...
![Finestra di creazione dell'organizzazione](media/windows-vm-configure/create-organization.png)

Una volta creata l'organizzazione, scaricare lo Starter Kit.

![Configurazione di Chef](media/windows-vm-configure/configure-chef.png)

> [!NOTE]
> Se viene visualizzato un messaggio di avviso che indica che le chiavi verranno reimpostate, è possibile procedere, perché non è ancora configurata alcuna infrastruttura.
>
...
### <a name="configure-a-chef-workstation"></a>Configurare una workstation Chef
...
![Esempio di file Knife](./media/windows-vm-configure/knife-file-example.png)
...
## <a name="create-a-chef-cookbook"></a>Creare un cookbook Chef
...
## <a name="upload-the-chef-cookbook-to-the-chef-server"></a>Caricare il cookbook Chef nel server Chef
...
![Macchina virtuale di cui è in corso il provisioning](./media/windows-vm-configure/virtual-machine-being-provisioned.png)

Di seguito viene visualizzato il prompt dei comandi.

![Output di Knife durante la creazione della macchina virtuale](./media/windows-vm-configure/knife-output-when-creating-vm.png)
...
![Test della macchina virtuale](./media/windows-vm-configure/vm-test.png)
...
![Visualizzazione dello stato del nodo](./media/windows-vm-configure/view-node-status.png)
