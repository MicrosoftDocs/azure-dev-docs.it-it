...
1. Selezionare **selezionare il plug-in per installare**.

    ![Selezionare l'opzione per installare i plug-in selezionati](./media/configure-on-linux-vm/select-plugins.png)

1. Nella casella del filtro nella parte superiore della pagina immettere `github`. Selezionare il plug-in GitHub e selezionare **Installa**.
