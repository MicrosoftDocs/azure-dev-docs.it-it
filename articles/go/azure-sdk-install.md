...
* [Distribuire una macchina virtuale da un modello](azure-sdk-qs-vm.md)
* [Trasferire oggetti nell'archivio BLOB di Azure con Azure Blob SDK per Go](/azure/storage/blobs/storage-quickstart-blobs-go?toc=/azure/developer/go/toc.json)
* [Connettersi a Database di Azure per PostgreSQL](/azure/postgresql/connect-go?toc=/azure/developer/go/toc.json)
...
* [Distribuire un'immagine del contenitore in Istanze di Azure Container](https://github.com/Azure-Samples/azure-sdk-for-go-samples/tree/master/compute)
* [Creare un cluster nel servizio Azure Kubernetes](https://github.com/Azure-Samples/azure-sdk-for-go-samples/blob/master/compute)
