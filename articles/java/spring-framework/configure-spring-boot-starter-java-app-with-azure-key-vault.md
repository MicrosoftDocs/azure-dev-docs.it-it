...
* [Installare l'interfaccia della riga di comando di Azure versione 2.0.67 o successiva](/cli/azure/install-azure-cli) e l'estensione Azure Spring Cloud con il comando `az extension add --name spring-cloud`
