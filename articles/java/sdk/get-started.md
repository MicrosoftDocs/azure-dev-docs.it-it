...
È possibile cercare il file di *helloazure.txt* nell'account di archiviazione tramite l'portale di Azure o con [Azure Storage Explorer](/azure/vs-azure-tools-storage-explorer-blobs).
